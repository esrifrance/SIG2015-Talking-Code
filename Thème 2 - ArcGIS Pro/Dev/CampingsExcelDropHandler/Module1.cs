...
{
    /// <summary>
    /// ArcGIS Pro Addin allows to Drag and drop campings.csv file on ArcGIS Pro and execute the necessary Geoprocessing Tools automatically. 
    /// </summary>
    /// <remarks> 
    ...
    /// 1. Drag and Drop campings.csl onto Pro.  
    /// 1. View the results of the France campings layer loaded into Pro with symbology applied  
    /// ![UI](Screenshots/2DView.png)
    /// 1. Switch to the 3D scene view  
    /// 1. Drag and Drop campings.csv on to ArcGIS Pro  
    /// 1. View those results.  
    /// ![UI](Screenshots/3DView.png)
    /// </remarks>
    internal class Module1 : Module
    {
        ...
        public static Module1 Current
        {
            get
            {
                return _this ?? (_this = (Module1)FrameworkApplication.FindModule("CampingsExcelDropHandler_Module"));
            }
        }
